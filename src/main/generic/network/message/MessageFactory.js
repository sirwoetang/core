...
MessageFactory.CLASSES[Message.Type.GETHEADERS] = GetHeadersMessage;
...
MessageFactory.CLASSES[Message.Type.GETACCOUNTS] = GetAccountsMessage;
MessageFactory.CLASSES[Message.Type.ACCOUNTS] = AccountsMessage;
